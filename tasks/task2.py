"""
Задание 2: Поиск циклов в графе

Реализует алгоритм поиска циклов с помощью поиска в глубину (DFS).

Алгоритм:
- DFS с отслеживанием обратных рёбер для обнаружения циклов
