"""
Задание 12: Поиск пути на карте (A*)

Реализует поиск кратчайшего пути на карте с помощью алгоритма A* с различными эвристиками.
...
Пример вывода:
    12 - length of path between (1, 1) and (5, 5) points.
    Path:
    (1, 1) -> (1, 2) -> ... -> (5, 5)
"""
